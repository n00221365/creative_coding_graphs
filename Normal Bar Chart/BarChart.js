 ...
 class StackedBarChart{
    ...
    print( this.data);
        for(let i=0; i<this.data.length; i++){
            ...
            // console.log( -this.data[i][this.topYValue]*scale);
            pop();
...
class AgeChart{
    ...
    //    console.log()
       ...
       let totalMaxValue = (topMaxValue + bottomMaxValue)
        ...
        for(let i=0; i<this.data.length; i++){
            fill(173, 216, 230);
            rect (0,0,this.data[i][this.bottomXValue],this.barWidth);

            push()
            translate(this.data[i][this.bottomXValue],0)
            fill(255,192,203)
            rect (0,0, this.data[i][this.topXValue],this.barWidth);
            pop()
